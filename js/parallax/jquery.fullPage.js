    ...
    $.fn.fullpage = function(options) {
        ...
        */
        function styleSection(section, index){
            ...
            if(options.paddingTop){
                ...
                section.css('margin-top', options.paddingTop);
            }
        ...
        */
        function addVerticalNavigation(){
            ...
            setTimeout(function(){
                var idx = $(SECTION_ACTIVE_SEL).index(SECTION_SEL);
                $(SECTION_NAV_SEL).find('li').eq(idx).find('a').addClass(ACTIVE);
            },10);
        }
        ...
        */
        ...
        /**
        * Activating the website breakcum text according to the given slide name.
        */
        function activateBreakcum(index){
            var breakcumTxt = $(SECTION_NAV_BREAKCUM_SEL).eq(index).find("a").text();
            $(SECTION_NAV_BREAKCUM).find('p.curActivePage').text(breakcumTxt);
        }
